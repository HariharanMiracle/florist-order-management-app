...
<body class="bg-light">
    ...
    <div>
        ...
        <div class="p-5">
            ...
            <div class="row">
                <div class="ml-5">
                    <form method="post" action=<%=baseUrl + "/order/listFilterPayBalance" %>>
                        <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                                if(order.getOrderStatus().equals("PROCESSING")){
                                                    %>
                                                        <a href=<%= baseUrl + "/order/payBalance/" + order.getId() %> type="button" class="btn btn-warning">Pay Balance</a>
                                                    <%
                                                }
                                                else{
                                                    %>
                                                        <p class="text-danger">You can pay balance to only processing order</p>
                                                    <%
                                                }
                                            %>
                                        </td>
